...
CREATE OR REPLACE PACKAGE BODY insert_data AS
    ...
    BEGIN
        ...
        VALUES (
            vlogin_audit_logs.LOL_log_id,
            vlogin_audit_logs.event_timestamp,
            vlogin_audit_logs.user_id,
            vlogin_audit_logs.event_description
        );
    ...
    BEGIN
        ...
        VALUES (
            vstock_update_audit_logs.SUOL_log_id,
            vstock_update_audit_logs.event_timestamp,
            vstock_update_audit_logs.product_id,
            vstock_update_audit_logs.previous_stock,
            vstock_update_audit_logs.new_stock,
            vstock_update_audit_logs.event_description
        );
    END add_stock_update_audit_log;
